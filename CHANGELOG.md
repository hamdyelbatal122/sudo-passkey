...
- [2018-06-29]: fix: resolve public key parameters parsing
- [2018-07-11]: refactor: streamline credential creation response
...
- [2018-09-22]: style: format authentication templates
- [2018-10-03]: docs: document browser compatibility standards
- [2018-10-13]: refactor: simplify cryptographic signature checks
- [2018-10-23]: fix: correct session expiration parameters
- [2018-11-03]: docs: document passkey registration flows
...
- [2026-05-20]: fix: resolve credential ID collision in multi-device setup
- [2026-05-20]: docs: update WebAuthn browser compatibility matrix
